...
<svelte:head>
  <title>Mipasaje Admin</title>
</svelte:head>

<div in:fade={{duration:550, delay:300}} class="h-fit w-full overflow-y-visible {$isDark? '':'bg-gray-100'} pb-10">
  <div class="container px-6 mx-auto grid">
    ...
    <div>
      <h2 class="my-6 ml-2 text-xl font-semibold text-gray-700 dark:text-gray-200">Punto de venta</h2>
