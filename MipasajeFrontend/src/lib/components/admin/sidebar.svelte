<script>
  import { closeSideMenu, pageMenus, togglePageMenu } from '$store/config';
...
<div class="py-4 text-gray-500 dark:text-gray-400">
  {#if withTitle}
    <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="/"> MiPasaje </a>
  {/if}
  <ul class="mt-6">
